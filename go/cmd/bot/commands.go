...
func registerBotCommands(ctx context.Context, b *tgbot.Bot, logger *slog.Logger) {
	groupCommands := []models.BotCommand{
		...
		{Command: "contextmode", Description: "Режим встроенного фильтра"},
		{Command: "allowcontext", Description: "Разрешить фразу для фильтра"},
		{Command: "unallowcontext", Description: "Убрать фразу из исключений"},
		{Command: "allowcontexts", Description: "Список исключений фильтра"},
